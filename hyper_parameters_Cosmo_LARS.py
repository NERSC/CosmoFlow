...
Model = {
        ...
        "LEARNING_RATE" : 0.002,       #adam_optimizer to do the update. 
...
RUNPARAM={
	...
	"num_epoch": 30,              #each epoch means a fully pass over the data. The program might stop before running num_epoch (see next line).        
        "require_improvement": 50,      #if with require_improvement, there is no improvement in validation error, then stop running. 
	"num_train":4900,                #total number of simulations for training
