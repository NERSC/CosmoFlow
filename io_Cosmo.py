...
def read_tfrecord(filename_queue):
    ...
    #normalize
    NbodySimus /= (tf.reduce_sum(NbodySimus)/64**3+0.) #### may need to do something about this? 
...
if __name__ == '__main__':
  ###I've replaced 400 with 100 and 499 with 120
    ...
    label_path = os.path.join('/global/cscratch1/sd/djbard/MUSIC_pyCola/egpbos-pycola-672c58551ff1/OmSi/twothousand/','list-500-noCiC-128from512.txt')
    ...
    for i in range(0,500):
        ...
        for j in order[i]:
            ...
            dirname = int(1000+(j/64))
            data_path = os.path.join('/global/cscratch1/sd/djbard/MUSIC_pyCola/egpbos-pycola-672c58551ff1/OmSi/twothousand/128from512/',str(dirname).rjust(3,'0'),str(numFile)+'.npy')
