...
if __name__ == '__main__':
    ...
    ### for test/val, need 64 repeated file all in teh same dir. 
    ### these are in the dirs 3794+ (since there are 3994 dirs total for these jobs) 
    for i in range(485,475+150):
        data = []
        label = []
        for j in range(64):
            ## for twothousand dir, just make all of them training. 
           
            numDirectory = (i)+(3794-475) ## don't want this to be random!! needs to be in the range 3794 - 3994
