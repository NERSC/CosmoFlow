...
if __name__ == '__main__':
  ###I've replaced 400 with 100 and 499 with 120
    ...
    label_path = os.path.join('/global/cscratch1/sd/djbard/MUSIC_pyCola/egpbos-pycola-672c58551ff1/OmSi/twothousand/','list-500-noCiC-128from256.txt')
    ...
    for i in range(0,500):
        ...
        for j in order[i]:
            ...
            data_path = os.path.join('/global/cscratch1/sd/djbard/MUSIC_pyCola/egpbos-pycola-672c58551ff1/OmSi/twothousand/128from256-500/',str(dirname).rjust(3,'0'),str(numFile)+'.npy')
            #print data_path
