...
if __name__ == '__main__':
    ...
    label_path = os.path.join('/global/cscratch1/sd/djbard/MUSIC_pyCola/egpbos-pycola-672c58551ff1/OmSiNs/twothousand-3/','list-2000-noCiC-128from256.txt')
    ...
    for i in range(1800,2000):
        ...
        for j in range(64):
            ...
            data_path = os.path.join('/global/cscratch1/sd/djbard/MUSIC_pyCola/egpbos-pycola-672c58551ff1/OmSiNs/twothousand-3/128from256-2000/',str(dirname).rjust(3,'0'),str(numFile)+'.npy')
            #print data_path
