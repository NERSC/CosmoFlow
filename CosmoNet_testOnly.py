...
#        os.environ['OMP_NUM_THREADS'] = '66' #####################configured it in batch script 
	...
	hp.RUNPARAM['batch_per_epoch_val'] = hp.RUNPARAM['batch_per_epoch_val'] / mc.get_nranks()  ########LEI ADDED
...
if __name__ == "__main__":
    ...
    trainCosmo = CosmoNet(train_data=NbodySimuDataBatch32,train_label=NbodySimuLabelBatch32,val_data=valDataBatch32,val_label=valLabelbatch32,test_data=testDataBatch32,test_label=testLabelbatch32,is_train=False, is_test=True)
    trainCosmo.train()
